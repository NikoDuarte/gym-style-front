...
import { _carrusel, _data_about } from '../interface/interface';
...
export class DataService {
  ...
  public dataCarrusel: _carrusel[] = [
    ...
    {
      title: 'GymStyle',
      img: 'https://images.pexels.com/photos/703016/pexels-photo-703016.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=1000'
    },
    {
      title: 'GymStyle',
